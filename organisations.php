...
<div class="panel-body" style="background- color:azure; margin: 0 0 0 15%; width:70%;">
  ...
  <form method="post" action="regprocess.php" enctype="multipart/form-data" autocomplete="off">
      ...
      <div class="form-group">
          <input type="text" name="fname" class="form-control" placeholder="Company Name" value="" required pattern="[a-zA-Z ]{0,20}">
      </div>						
      <div class="form-group">
          <input type="numeric" name="co" placeholder="Total Placements" required pattern="[0-9]{}" class="form-control">
      </div>            
  ...
  <input type="file" name="image" required />
      ...
      <div class="form-group">
         <center> <button type="submit" class="btn btn-primary" name="orgsubmit">Submit</button> &nbsp;  &nbsp;  &nbsp;  &nbsp;
             <button type="reset" style="background-color:red;" class="btn btn-primary" name="orgsubmit">Reset</button></center>
      </div>
    </form>
