...
<div class="panel-body" style="background- color:cyan; margin: 0 0 0 35%; width:30%;">
    <center><h1 style="margin-top:5px;margin-bottom:15px;"> Admin Panel </h1></center><hr/>
  <form method="post" action="regprocess.php" enctype="multipart/form-data" autocomplete="off">

      <div class="form-group">
          <input type="text" name="user" class="form-control" placeholder="LogIn ID" value="" required>
      </div>				  
       <div class="form-group">
      ...
      <div class="form-group">
          <center><input type="submit" class="btn btn-primary" name="logsubmit" value="Log IN"></center>
      </div>
    </form>
